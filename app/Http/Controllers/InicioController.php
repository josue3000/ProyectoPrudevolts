...
//$numero = $numer;
  ...
  if($total == '0')
  {
    $total == '1';
        ...
        // $pdf = PDF::loadView('pdf.reporteAdmin', compact('cancelados','servicios','deudas','reclamo','pendiente','entregado2','entregado','recibido','listoparaentregar','repuestos','ventasReparacion','ventasReclamos','presupuesto','presupuestos','serviciosPresupuestados','total','enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre','numero','ventaListos'));

       
         $pdf = PDF::loadView('pdf.reporte',["cancelados"=>$cancelados,"servicios"=>$servicios,"deudas"=>$deudas,"reclamo"=>$reclamo,"pendiente"=>$pendiente,"entregado2"=>$entregado2,"entregado"=>$entregado,"recibido"=>$recibido,"listoparaentregar"=>$listoparaentregar,"repuestos"=>$repuestos,"ventasReparacion"=>$ventasReparacion,"ventasReclamos"=>$ventasReclamos,"presupuesto"=>$presupuesto,"presupuestos"=>$presupuestos,"serviciosPresupuestados"=>$serviciosPresupuestados,"total"=>$total,"enero"=>$enero,"febrero"=>$febrero,"marzo"=>$marzo,"abril"=>$abril,"mayo"=>$mayo,"junio"=>$junio,"julio"=>$julio,"agosto"=>$agosto,"septiembre"=>$septiembre,"octubre"=>$octubre,"noviembre"=>$noviembre,"diciembre"=>$diciembre,"numero"=>$numero,"ventaListos"=>$ventaListos]);
