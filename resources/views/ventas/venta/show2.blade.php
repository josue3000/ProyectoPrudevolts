          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              ...
              <address>
                              ...
                              <br>La Paz - Bolivia
                              <br>Telefono: 2-2796576
                              <br>Telefono: 70626476
                              <br>Telefono: 61157300
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <address>
                              ...
                              <br><strong>Diagnostico:</strong>
                              <br>{{$venta->diagnostico}}
                              <br><strong>Diagnostico Preliminar:</strong>
                              <br>{{$venta->diagnostico}}
                              <br><strong>Diagnostico Técnico:</strong>
