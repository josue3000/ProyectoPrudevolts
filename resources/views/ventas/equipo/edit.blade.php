        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h3>Editar Equipo: {{$equipo->serial}} : {{$equipo->tipo_equipo}}</h3>
                    @if (count($errors)>0)
                    ...
                    {!!Form::model($equipo, ['method'=>'PATCH', 'route' => ['equipo.update' ,$equipo->id_equipo],'files'=>'true'])!!}
                    {!! Form::token() !!}
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="persona" id="" class="form-control">
                                    @foreach ($propietarios as $prop)
                                        @if ($prop->id_persona==$equipo->persona)
                                        <option value="{{$prop->id_persona}}" selected>{{$prop->nombre}}</option>
                                        @else
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            ...
                            <input type="text" name="serial" required value="{{$equipo->serial}}" class="form-control">
                            </div>
                        </div>
                ...
                {{-- <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="tipo_equipo" id="tipo_equipo" class="form-control selectpicker" data-live-search="true">
                            ...
                            <option value="Refrigerador frio Seco digital">Refrigerador frio Seco digital</option>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="tipo_equipo" id="tipo_equipo" class="form-control selectpicker" data-live-search="true">
                            ...
                            @if ($tipo->id_tipo_equipo==$equipo->tipo_equipo)
                            <option value="{{$tipo->id_tipo_equipo}}" selected>{{$tipo->nombre}}</option>
                            @else
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="marca" id="marca" class="form-control selectpicker" data-live-search="true">
                            ...
                            @if ($marca->id_marca==$equipo->marca)
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                @if (($equipo->imagen)!= "")
                                <img src="{{asset('imagenes/equipos/'.$equipo->imagen)}}" alt="" height="300px" width="300px">
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
...
<script>
  $('#color').val('<?php echo $equipo->color ?>');
