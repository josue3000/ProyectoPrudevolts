        ...
        <div class="x_panel">
            <div class="x_title">
                <h3>Listado de Solicitudes
                    @can('Sol.create')
                    <a href="solicitud/create1"><button class="btn btn-success"><i class="fa fa-plus"></i> Nuevo</button></a>
                    @endcan
                </h3>
            ...
            {{-- <div class="x_content"> --}}
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                @can('Sol.edit')
                                <a href="{{URL::action('SolicitudController@edit', $sol->id_solicitud)}}"><button class="btn btn-info"><i class="fa fa-pencil"></i> Editar</button></a>
                                @endcan
                                @can('Sol.show')
                                <a href="{{URL::action('SolicitudController@show', $sol->id_solicitud)}}"><button class="btn btn-primary"><i class="fa fa-list"></i> Detalles</button></a>
                                @endcan
                                @can('Sol.destroy')
