        ...
        <div class="">
            ...
            <div class="x_panel">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    ...
                    <input type="text" name="nombre" value="{{$personas->nombre}}" class="form-control" placeholder="Nombre...">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" hidden>
                    ...
                    <input type="text" name="id_persona" value="{{$personas->id_persona}}" class="form-control" placeholder="id_persona">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" hidden>
                    ...
                    <input type="text" name="cliente" value="{{$personas->id_persona}}" class="form-control" placeholder="cliente">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        <label for="">Documento</label>
                        <select name="tipo_documento" id="" class="form-control">
                            @if ($personas->tipo_documento=='Carnet de Identidad')
                                <option value="Carnet de Identidad" selected>Carnet de Identidad</option>
                                <option value="NIT">NIT</option>
                                <option value="Pasaporte">Pasaporte</option>
                            @elseif ($personas->tipo_documento=='NIT')
                                <option value="Carnet de Identidad">Carnet de Identidad</option>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="num_documento" value="{{$personas->num_documento}}" class="form-control" placeholder="Número del documento...">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
                        <label for="telefono">Teléfono</label>
                        <input type="text" name="telefono" required value="{{$personas->telefono}}" class="form-control" placeholder="Teléfono...">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="form-group">
