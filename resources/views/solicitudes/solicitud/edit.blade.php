...
@section('contenido')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            {!!Form::model($solicitud, ['method'=>'PATCH', 'route' => ['solicitud.update' ,$solicitud->id_solicitud]])!!}
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea class="form-control" style="height:155px;" id="descripcion" name="descripcion" placeholder="Descripcion ..."> {{$solicitud->descripcion}}</textarea> 
                    </div>
                </div>
