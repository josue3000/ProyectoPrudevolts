...
<body>
    <h1>Correo Electronico de Notificacion de servicio: Servicio Presupuestado👍.</h1>
    <h3>Mediante el presente correo electronico, no permitimos informarle sobre el presupuesto realizado, esperando su respuesta positiva, puede comunicarse con nosotros para cualquier duda y confirmar la realización del servicio.👌</h3>
        ...
        <div class="row">
          ...
          <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <br><strong>NOTA: a continuación se muestran las actividades de servicios necesarias y Repuestos para el desarrollo del presente servicio, como detalle del presupuesto realizado y pueda ser aprobado por su persona.</strong>
            </div>
          </div>
